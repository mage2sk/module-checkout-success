...
namespace Panth\CheckoutSuccess\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_CheckoutSuccess';

    public const COMPOSER_PACKAGE = 'mage2kishan/module-checkout-success';
